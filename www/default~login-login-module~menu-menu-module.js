(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~login-login-module~menu-menu-module"],{
...
let HttpService = class HttpService {
    ...
    post(serviceName, data) {
        ...
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl;
...
let AuthService = class AuthService {
    constructor(http, httpService, storageService, router) {
        this.http = http;
   ...
   */
    ...
    login(email, password) {
        ...
        const header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({ 'Content-Type': 'application/json' });
...
//# sourceMappingURL=default~login-login-module~menu-menu-module.js.map